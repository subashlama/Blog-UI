...
import "../src/css/custom-responsive-style.css"
import dsLogo from "../src/images/ds-logo.svg"
import pOne from "../src/images/p-one.jpg"
import pTwo from "../src/images/p-two.jpg"
import pThree from "../src/images/p-three.jpg"
import pFour from "../src/images/p-four.jpg"
import pFive from "../src/images/p-five.jpg"
import pSix from "../src/images/p-six.jpg"
            ...
            <nav class="main-navigation">
              <div class="container clearfix">
                <div class="site-logo-wrap">
                  <a class="logo" href="#">
                    <img src={dsLogo} alt="Design Studio" />
                  </a>
                </div>
                <a href="javascript:void(0)" class="menu-trigger hidden-lg-up">
                  <span>&nbsp;</span>
                </a>
            ...
            <div class="container">
              ...
              <div class="portfolio-wrapper clearfix">
                <a
                  ...
                  href="images/p-one.jpg"
                >
                  <img src={pOne} alt="p-one" />
                ...
                <a
                  class="each-portfolio"
                  data-fancybox="gallery"
                  href="images/p-two.jpg"
                >
                  <img src={pTwo} alt="p-one" />
                  <div class="hover-cont-wrap">
                    <div class="hover-cont-block">
                      <h5 class="p-title">Title</h5>
                      <div class="p-desc">
                ...
                <a
                  class="each-portfolio"
                  data-fancybox="gallery"
                  href="images/p-three.jpg"
                >
                  <img src={pThree} alt="p-one" />
                  <div class="hover-cont-wrap">
                    <div class="hover-cont-block">
                      <h5 class="p-title">Title</h5>
                      <div class="p-desc">
                ...
                <a
                  class="each-portfolio"
                  data-fancybox="gallery"
                  href="images/p-four.jpg"
                >
                  <img src={pFour} alt="p-one" />
                  <div class="hover-cont-wrap">
                    <div class="hover-cont-block">
                      <h5 class="p-title">Title</h5>
                      <div class="p-desc">
                ...
                <a
                  class="each-portfolio"
                  data-fancybox="gallery"
                  href="images/p-five.jpg"
                >
                  <img src={pFive} alt="p-one" />
                  <div class="hover-cont-wrap">
                    <div class="hover-cont-block">
                      <h5 class="p-title">Title</h5>
                      <div class="p-desc">
                ...
                <a
                  class="each-portfolio"
                  data-fancybox="gallery"
                  href="images/p-six.jpg"
                >
                  <img src={pSix} alt="p-one" />
                  <div class="hover-cont-wrap">
                    <div class="hover-cont-block">
                      <h5 class="p-title">Title</h5>
                      <div class="p-desc">
            ...
            <div class="testimonial-wrap">
              <div class="container">
                ...
                <ul class="testimonial-slider">
                  <li>
                    " I would like to thank Click and the team for the fantastic
                    work
                    <br /> on content writing for my site. "
                  </li>
                  <li>
                    " I'd say that the team is excellent and it is some of the
                    best service
                    <br /> I have received both online and offline in a long
                    time. "
                  </li>
                  <li>
                    " It's been great working with you. The content is also
                    great. I can certainly recommend your
                    <br /> services to others as cost effective services. "
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div class="contact-outer-wrapper">
                <div class="address-block">
                  ...
                  <div class="c-detail">
                    ...
                    <span class="c-info">
                      12 Avenue center, st. marks road, CA
                    </span>
                  </div>
                  <div class="c-detail">
                    <span class="c-icon">
                    ...
                    <span class="c-info">+41982399090000</span>
                  </div>
                  <div class="c-detail">
                    <span class="c-icon">
                      <i class="fa fa-envelope" aria-hidden="true"></i>
                    </span>{" "}
                    <span class="c-info">click@gmail.com</span>
                  </div>
                </div>
                <div class="form-wrap">
                  ...
                  <form>
                    ...
                    <div class="user-msg floating-label">
                      <textarea
                        ...
                        id="user-msg-field"
                      ></textarea>
                      <label for="user-msg-field" class="msg-label">
                        Your Message
                      </label>
                    </div>
          ...
          <footer id="Footer">
            <div class="container">
              ...
              <div class="footer-logo-wrap">
                Design Studio &copy; 2018. Designed by{" "}
